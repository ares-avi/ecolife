...
.el-layout-group .coloum-left {
    width: 160px;
    float: left;
    display: inline-table;
}
.el-layout-group .coloum-middle {
    width: 800px;
    display: inline-table;
    margin-left: 6px;
    margin-right: 6px;
}
.el-layout-group .el-inner {
    width: 995px;
}
.el-group-members {
    height: 102px;
...
.el-group-cover:hover > .el-group-cover-button {
    display: block;
}
...
.el-groups-notification-icon,
.el-groups-notification-icon:before {
    display: inline-block;
}	
.el-groups-notification-icon:before {
	content: "\f0c0";
...
.el-group-notification-item .data {
    display: inline;
    margin-left: 5px;
}
.delete-group {
...
.el-notification-unviewed {
    background: #F9F9F9;
}
.el-group-profile .widget-description .widget-contents {
    text-align: justify;
}
.el-group-profile .group-requests-widget .widget-contents {
	text-align:center;
}
.el-group-profile .group-requests-widget a {
    font-weight: bold;
    text-transform: uppercase;
}
.el-group-members .request-controls {
}
.el-group-members .request-controls a {
	margin-left:5px;
}
.el-group-members .col-md-2 {
	text-align:center;
}
...
.group-search-details .el-group-search-by {
    margin-top: 5px;
}
.group-search-details .el-group-search-by a {
    margin-left: 5px;
}
