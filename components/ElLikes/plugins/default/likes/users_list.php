...
foreach ($users as $user) {
    ...
    ?>
<div class="el-reactions-list-wholiked-item">
<div class="row">
	<div class="col-md-2 col-xs-3">
		<img src="<?php echo $icon; ?>"/>
	</div>
	<div class="col-md-10 col-xs-9">
		<div class="el-reactions-list-whoreacted-uinfo">
			<a class="userlink" href="<?php echo el_site_url(); ?>u/<?php echo $user->username; ?>"><?php echo $user->fullname; ?></a>
			<div class="el-reaction-list el-reactions-list-whoreacted">
