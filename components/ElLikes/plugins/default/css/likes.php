.el-likes-view a.right.btn.btn-danger {
	font-size: 12px;
	margin-top: 8px;
	margin-right: 5px;
...
.el-likes-view a.right.btn.btn-primary {
	font-size: 12px;
	margin-top: 8px;
	margin-right: 5px;
	padding: 3px 5px 3px 5px;
...
.el-like-reactions-panel li:after {
	margin-left: 0px;
	margin-right: 0px;
	content: '';
}

.el-like-reactions-panel li {
	display: inline-block;
	width: 40px;
	height: 40px;
	cursor: pointer;
...
.el-reaction-list .emoji {
	transform: scale(0.133);
	margin-left: -55px;
	margin-top: -50px;
}

.el-reaction-list .emoji--dislike {
...
.el-reaction-title-wholiked {
	margin-left: 10px;
}

.el-reaction-list .emoji__eyes:after,
.el-reaction-list .emoji__tongue,
.el-reaction-list .emoji__eyebrows,
.el-reaction-list .emoji__eyes,
.el-reaction-list .emoji__face,
.el-reaction-list .emoji__mouth,
.el-reaction-list .emoji__face,
.el-reaction-list .emoji__heart,
.el-reaction-list .emoji__hand {
	animation: none;
}

.el-reactions-list-whoreacted .emoji {}

.el-reactions-list-wholiked-item img {
	border: 1px solid #eee;
	border-radius: 100%;
}

.el-reactions-list-wholiked-item {
...
.el-reactions-list-whoreacted-uinfo a {
	font-weight: bold;
}

.el-reactions-list-whoreacted {
	float: none;
	margin-left: 5px;
}
...
@media (max-width: 480px) {
	...
	.comment-contents .el-like-reactions-panel {
		margin-left: -30px;
	}
}

.el-likes-annotation-total {
	float: right;
}

.comment-metadata .el-reaction-list {
	float: right;
	margin-left: 10px;
}

.comment-metadata .el-reaction-list .emoji {
	transform: scale(0.12);
	margin-top: -51px;
}

.comment-metadata .el-reaction-list .emoji--dislike {
