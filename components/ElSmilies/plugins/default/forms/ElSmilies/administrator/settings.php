...
<label><?php echo el_print('el:smilies:admin:settings:compat:title');?></label>
<?php echo el_print('el:smilies:admin:settings:compat:note');?>
<select name="compatibility_mode">
	...
	?>
	<option value="off" <?php echo $compat_off;?>><?php echo el_print('el:admin:settings:off');?></option>
	<option value="on" <?php echo $compat_on;?>><?php echo el_print('el:admin:settings:on');?></option>
</select>
<br />
<label><?php echo el_print('el:smilies:admin:settings:close_anywhere:title');?></label>
<?php echo el_print('el:smilies:admin:settings:close_anywhere:note');?>
