<script>$(document).ready(function(){el.commentTyping(<?php echo $params['params']['entity']->guid;?>, 'entity');});</script>
	...
	<div class="comments-item ctyping-c-item ctyping-hide">
    	...
    	<div class="row">
        	<div class="col-md-12">
                ...
                <span class="ctyping-text"><?php echo el_print('rtcomments:typing');?></span>
        	</div>
    	</div>
        </div>
	</div>
