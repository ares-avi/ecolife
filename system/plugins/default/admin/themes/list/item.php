<?php
 ...
 $themes =  new ElThemes; 
 $translit = ElTranslit::urlize($params['theme']->name);
 ...
 if(el_site_settings('theme') !== $id) {
      $enable = el_site_url("action/theme/enable?theme={$id}", true);
	  $enable = "<a href='{$enable}' class='btn btn-success'><i class='fa fa-check'></i>".el_print('admin:button:enable')."</a>";

	  $delete = el_site_url("action/theme/delete?theme={$id}", true);
	  $delete = "<a href='{$delete}' class='btn btn-danger'><i class='fa fa-close'></i>".el_print('admin:button:delete')."</a>";	  
 } 
?> 	
    <div class="panel panel-default margin-top-10">
      <div class="panel-heading">
        <h4 class="panel-title">
          ...
          <?php if (el_site_settings('theme') == $id){ ?>
      ...
      <div id="collapse-<?php echo $translit;?>" class="panel-collapse collapse">
        <div class="panel-body">
            ...
            <div class="alert alert-danger">
            	<?php echo el_print('admin:old:theme', array($id)); ?>
            </div>
            <div class="margin-top-10 components-list-buttons">
                      <?php echo $delete;?>
             </div>
