 ...
 * ));
 */
class ElDatabase extends ElBase {
		/**
		...
		public function __construct() {
				global $El;
				if(!isset($El->dbLINK) || isset($El->dbLINK) && $El->dbLINK == false) {
						$El->dbLINK = $this->Connect();
				}
				//set the sql mode and avoid setting again and again for each request
				if(!isset($El->setSQLMode)) {
		...
		public function Connect() {
				...
				try {
						...
						throw new ElDatabaseException($ex->getMessage());
				}
		}
		/**
