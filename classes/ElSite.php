<?php
class ElSite extends ElDatabase {
		/**
		 * Get site settings;
		 *
		...
		public function getAllSettings($reserved = true) {
				$params['from'] = 'el_site_settings as s';
		...
		public function setSetting($name, $value = '') {
				...
				if($settings !== false && isset($this->settings->setting_id) && !empty($this->settings->setting_id)) {
						$params['table']  = 'el_site_settings as s';
						$params['names']  = array(
								'value'
						);
						$params['values'] = array(
